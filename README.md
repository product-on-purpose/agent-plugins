...
| `product-lifecycle-templates` | 30 researched document templates across the product lifecycle, each with a lean and full variant, a worked example, and the research log every claim traces to | `product-on-purpose/product-lifecycle-templates` | listed |
