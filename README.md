...
| `product-lifecycle-templates` | 30 researched document templates across the product lifecycle, each with a lean and full variant, a worked example, and the research log every claim traces to. Browsable at [product-on-purpose.github.io/product-lifecycle-templates](https://product-on-purpose.github.io/product-lifecycle-templates/) | `product-on-purpose/product-lifecycle-templates` | listed |
