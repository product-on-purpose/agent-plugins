...
| `writing-style-catalog` | Composable writing instructions on four orthogonal axes (Voice, Tone, Style, Format), with skills to compose an instruction, capture a personal default style, and recommend a combination for a described situation | `product-on-purpose/writing-style-catalog` | listed |
...
| `product-lifecycle-templates` | 33 researched document templates across the product lifecycle, each with a lean variant (30 also with a full one), a worked example, and the research log every claim traces to. Browsable at [product-on-purpose.github.io/product-lifecycle-templates](https://product-on-purpose.github.io/product-lifecycle-templates/) | `product-on-purpose/product-lifecycle-templates` | listed |
